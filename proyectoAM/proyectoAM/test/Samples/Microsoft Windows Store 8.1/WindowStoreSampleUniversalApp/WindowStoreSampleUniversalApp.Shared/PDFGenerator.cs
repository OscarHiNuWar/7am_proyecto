...
namespace WindowStoreSampleUniversalApp
{
    ...
    {
        /// <summary>
        /// Creates sample PDF file and returns corresponding StorageFile object.
        /// </summary>
        /// <returns>
        /// StorageFile object representing the generated PDF file.
        /// </returns>
        public static async Task<StorageFile> GeneratePdf()
        {
            ...
            StorageFile dataFile = await StorageFile.GetFileFromPathAsync(Path.Combine(dataPath.Path, "data.txt"));
