    ...
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            using (FileStream fs = new FileStream(out_path, FileMode.Create))
            {
                ...
                CheckBoxFieldView checkBoxFieldView = new CheckBoxFieldView(checkBoxField, new Boundary(10, 400, 210, 450));
                ...
                CheckBoxFieldView boxFieldView = new CheckBoxFieldView(checkBox, new Boundary(10, 460, 210, 500));
