    ...
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            using (FileStream fs = new FileStream(@"..\..\..\..\OutputDocuments\ListAttachmentsAndFileAnnotationsNames.pdf", FileMode.Create))
            {
                ...
                // add attachment
                document.Attachments.Add("Attachment # 1", new EmbeddedFile(test_file, "type/pdf"));
                document.Attachments.Add("Attachment # 2", new EmbeddedFile(test_file, "type/pdf"));
                document.Attachments.Add("Attachment # 3", new EmbeddedFile(test_file, "type/pdf"));
