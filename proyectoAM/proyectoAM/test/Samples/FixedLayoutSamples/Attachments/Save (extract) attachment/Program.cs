    ...
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            using (FileStream fs = new FileStream(out_path, FileMode.Create))
            {
                ...
                // add attachment
                document.Attachments.Add("Attachment # 1", new EmbeddedFile(@"..\..\..\..\OutputDocuments\testfile.pdf", "type/pdf"));
                document.Attachments.Add("Attachment # 2", new EmbeddedFile(@"..\..\..\..\OutputDocuments\testfile.pdf", "type/pdf"));
                document.Attachments.Add("Attachment # 3", new EmbeddedFile(@"..\..\..\..\OutputDocuments\testfile.pdf", "type/pdf"));

                // save document
                document.Save(fs);
                
                // get list of attachments
                Console.WriteLine("The count of attachments before is : " + document.Attachments.Count);
            ...
            using (FileStream outPdf = new FileStream(out_path, FileMode.Open))
            {
                ...
                System.IO.Stream attachmentStream = document.Attachments["Attachment # 2"].GetStream();
                
                //  remove attachment from document
                document.Attachments.RemoveAttachment("Attachment # 3");
